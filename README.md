# MarkFlow - WYSIWYG Markdown & Excalidraw 编辑器

一个简洁优雅的编辑器，提供**真正的所见即所得**写作体验，同时支持 Markdown 和 Excalidraw 绘图。
...
- **目录树**：左侧侧边栏显示文件夹下的所有文件和子目录
- **文件切换**：点击侧边栏中的文件，即可在编辑器中打开
- **折叠/展开**：侧边栏支持折叠，最大化写作空间
- **右键菜单**：支持创建、重命名、删除文件和文件夹
- **文件类型图标**：Markdown 文件和 Excalidraw 文件显示不同图标
